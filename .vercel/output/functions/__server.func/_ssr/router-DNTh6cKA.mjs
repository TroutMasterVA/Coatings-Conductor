...
import { n as auth } from "./server-Cdz9EoOm.mjs";
import { n as TriangleAlert } from "../_libs/lucide-react.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DNTh6cKA.js
...
var styles_default = "/assets/styles-6cH7KliE.css";
var APP_NAME = "Coatings Conductor";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Coatings Conductor turns a product data sheet into a pocket job card and NOAA application windows by ZIP."
			}
		],
		links: [
			{
...
var $$splitComponentImporter$1 = () => import("./routes-BvCpz6eQ.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-BY_M3W8S.mjs");
var Route$1 = createFileRoute("/login")({
	validateSearch: (search) => ({ mode: search.mode === "in" ? "in" : "up" }),
